...
export class AdminService {
  ...
  /*NUEVOS MODULOS IMPLEMENTADOS DE ADMINISTRADOR INICIO */
  listar_admins_tienda(token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'listar_admins_tienda', { headers: headers });
  }
  obtener_admin_seleccionado(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'obtener_admin_seleccionado/' + id, { headers: headers });
  }
  ...
  actualizar_admin_seleccionado(id: any, data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Authorization': token });
    return this._http.put(this.url + 'actualizar_admin_seleccionado/' + id, data, { headers: headers });
  }
  eliminar_admin_seleccionado(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.delete(this.url + 'eliminar_admin_seleccionado/' + id, { headers: headers });
  }
  cambiar_pass_admin_seleccionado(id: any, data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.put(this.url + 'cambiar_pass_admin_seleccionado/' + id, data, { headers: headers });
  }

  /*CLIENTES */
  obtener_cliente_seleccionado(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'obtener_cliente_seleccionado/' + id, { headers: headers });
  }
  cambiar_pass_cliente_seleccionado(id: any, data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.put(this.url + 'cambiar_pass_cliente_seleccionado/' + id, data, { headers: headers });
  }

  eliminar_cliente_seleccionado(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.delete(this.url + 'eliminar_cliente_seleccionado/' + id, { headers: headers });
  }
  /*FIN CLIENTES */

  /*NUEVOS MODULOS IMPLEMENTADOS DIN!!!! */
  ...
  registro_categoria_admin(data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.post(this.url + 'registro_categoria_admin', data, { headers: headers });
  }

  listar_categorias_admin(token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'listar_categorias_admin', { headers: headers });
  }
  ...
  actualizar_categoria_admin(id: any, data: any, token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
  ...
  /*FIN DE SERVICIOS PARA CATEGORIAS */

  /*SERVICIOS PARA ETIQUETAS */
  ...
  /*FIN DE SERVICIOS PARA VARIEDADES */
  ...
  /* SERVICIOS PARA MÓDULO DE CATALOGOS */
  obtener_catalogos (token: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'obtener_catalogos', { headers: headers });
  }
}
